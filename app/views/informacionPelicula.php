<section>
    <div class="grid grid-cols-2">
        <div>
            ...
            <h1 class="p-8 text-white  text-7xl font-poppins font-normal">Titulo</h1>
            ...
            <p class="text-white font-normal font-poppins text-sm ml-8 mt-7">sdsfddfrgrthtyjht</p> <!--Argumento-->
        ...
        <div>
            <img src="app/images/carteles/" class="w-1000 h-620 -ml-193 rounded-md" alt="">
        </div>
    </div>
</section>