...
<section class="bg-fond_inicio rounded-2xl mt-12 mb-16 h-72 ml-8">
    <div class="grid grid-cols-2 p-8 text-center">
        <div class="flex gap-12 ml-56">
            <a href="index.php?ctl=butacas" class="bg-button_gray_4 w-28 h-14 text-white font-medium font-poppins text-lg rounded-md" type="button"><p class="mt-3">Sala 1</p></a>
            <button class="bg-button_gray_3 w-28 h-14 text-white font-medium font-poppins text-lg rounded-md">Sala 2</button>
        </div>
        <div>
    ...
    <div class="flex gap-12 ml-56">
        <button class="bg-p_rose_2 w-28 h-14 text-white font-medium font-poppins text-lg rounded-md ml-8">17:45</button>
        <button class="bg-p_rose w-28 h-14 text-white font-medium font-poppins text-lg rounded-md">20:15</button>
        <button class="bg-p_rose_2 w-28 h-14 text-white font-medium font-poppins text-lg rounded-md">12:00</button>
    </div>
</section>
<section>
    ...
    <div class="flex gap-2 mt-5 ml-80">
            <a href=""><img src="app/images/salaButacas/butaca2.png" class="w-11 h-10"></a>
            <a href=""><img src="app/images/salaButacas/butaca2.png" class="w-11 h-10"></a>
            <a href=""><img src="app/images/salaButacas/butaca2.png" class="w-11 h-10"></a>
            <a href=""><img src="app/images/salaButacas/butaca1.png" class="w-11 h-10"></a>
